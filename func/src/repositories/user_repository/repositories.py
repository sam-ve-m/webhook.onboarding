...
class UserRepository:
    ...
    @classmethod
    async def update_ouroinvest_exchange_account_information_of_user(
            cls,
            cpf: str,
        ...
        try:
            if message.get("statusCadastro") == "Concluído":
                exchange_account_information = {
                    "$set": {
                        "ouro_invest": exchange_account,
                        "ouro_invest.status": message
                    }
                }
